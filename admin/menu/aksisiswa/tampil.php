             ...
             <?php
              ...
              ?>
               <tr>
                 ...
                 <td>
                   <center><?php echo "$tgl/$bln/$thn"; ?></center>
                 </td>
                 <td><img src="foto/<?php echo $data['foto'] ?>" width="40" height="40" class="circle valign profile-image materialboxed"></td>
                 <td>
                   <center><a href="?menu=siswa&aksi=editdatasiswa&id=<?php echo $data['kode_siswa']; ?>" class="btn-floating waves-effect waves-light btn-flat deep-purple btn tooltipped" data-position="left" data-delay="50" data-tooltip="Edit"><i class="mdi-content-create"></i></a> &nbsp;
                     <a onClick="swal({
                                            title: 'Anda yakin?',
