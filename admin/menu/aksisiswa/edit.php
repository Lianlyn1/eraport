<div class="row">
  <div class="col s12 m12 l12">
    <div class="card-panel">
      ...
      <div class="row">
        <?php
        $edit = mysqli_query($connect, "select * from siswa where  kode_" . $menu . "='$_GET[id]'") or die("gagal" . mysqli_error($connect));
          ...
          <form action="aksi.php?menu=siswa&aksi=edit" method="post" onSubmit="return validasi_editsiswa(this);" enctype="multipart/form-data" class="col s12">
            ...
            <div class="row">
              ...
              <div class="input-field col s12 m2 l2">
                ...
                <input name="jenis_kelamin" type="radio" value="Laki-laki" id="laki_laki" <?php if ($data['jenis_kelamin'] == "Laki-laki") {
                                                                                            echo "checked";
                                                                                          } ?>>
                <label for="laki_laki">Laki-laki</label><br>


                <input name="jenis_kelamin" type="radio" value="Perempuan" id="perempuan" <?php if ($data['jenis_kelamin'] == "Perempuan") {
                                                                                            echo "checked";
                                                                                          } ?>>
            ...
            <div class="row">
              <div class="input-field col s12 m6 l6">
                <select name="kolomstatus" id="status">
                  ...
                  <option value="Tidak" <?php if ($data['status'] == "Tidak") {
                                          echo "selected";
                                        } ?>>Tidak</option>
                </select>
                <label>Status</label>
              ...
              <div class="input-field col s12 m6 l6">
                <select name="tahun_angkatan" id="tahun_angkatan">
                  ...
                  ?>
                    <option value='<?php echo $tahun_awal . '/' . $tahun_tambah; ?>' <?php if ($data['tahun_angkatan'] == $tahun_awal . '/' . $tahun_tambah) {
                                                                                        echo "selected";
