<div class="row">
  <div class="col s12 m12 l12">
    <div class="card-panel">
      ...
      <div class="row">
        <?php
        $edit = mysqli_query($connect, "select * from kelas where kode_kelas='$_GET[id]'") or die("gagal" . mysqli_error($connect));
        ...
        ?>
          <form action="aksi.php?menu=kelas&aksi=edit" method="post" onSubmit="return validasi_tambahkelas(this);" enctype="multipart/form-data" class="col s12">
            ...
            <div class="row">
              <div class="input-field col s12 m6 l6">
                <select name="tahun_ajar" id="tahun_ajar" disabled>
                  ...
                  ?>
                    <option value="<?php echo $tahun_awal . '/' . $tahun_tambah; ?>" <?php if ($data['tahun_ajar'] == "$tahun_awal/$tahun_tambah") {
                                                                                        echo "selected";
                                                                                      } ?>><?php echo "$tahun_awal/$tahun_tambah"; ?></option>
                  <?php
                  }
                  ?>
            ...
            <div class="row">
              <div class="input-field col s12 m6 l6">
                <select name="nama_kelas" id="nama_kelas" disabled>
                  ...
                  <option value="Kelas A" <?php if ($data['nama_kelas'] == "Kelas A") {
                                            echo "selected";
                                          } ?>>Kelas A</option>
                  <option value="Kelas B" <?php if ($data['nama_kelas'] == "Kelas B") {
                                            echo "selected";
                                          } ?>>Kelas B</option>
                  <option value="Kelas C" <?php if ($data['nama_kelas'] == "Kelas C") {
                                            echo "selected";
                                          } ?>>Kelas C</option>
                </select>
            ...
            <div class="row">
              <div class="input-field col s12">
                <?php
                $editguru = mysqli_query($connect, "select * from guru, kelas where kode_kelas='$_GET[id]' and kelas.kode_guru=guru.kode_guru") or die("gagal" . mysqli_error($connect));
                $dataguru = mysqli_fetch_array($editguru);
