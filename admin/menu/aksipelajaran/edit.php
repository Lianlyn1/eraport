<div class="row">
  <div class="col s12 m12 l12">
    <div class="card-panel">
      ...
      <div class="row">
        <?php
        $edit = mysqli_query($connect, "select * from pelajaran where kode_pelajaran='$_GET[id]'") or die("gagal" . mysqli_error($connect));
            ...
            <div class="row">
              <div class="input-field col s12">
                <select name="keterangan" id="status">
                  ...
                  <option value="Wajib" <?php if ($data['keterangan'] == "Wajib") {
                                          echo "selected";
                                        } ?>>Wajib</option>
                  <option value="Tambahan" <?php if ($data['keterangan'] == "Tambahan") {
                                              echo "selected";
                                            } ?>>Tambahan</option>
                </select>
