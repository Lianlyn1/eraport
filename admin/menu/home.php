  <?php
    $query = mysqli_query($connect, "SELECT (select count(nis) from siswa) as jumlah_siswa, 
                      ...
                      <div class="col s12 m6 l4">
                          <div class="card">
                              <div class="card-content   teal darken-1 white-text">
                                  ...
                                  <p class="card-stats-compare"><?php echo $data['jumlah_siswa']; ?> <span class="green-text text-lighten-5">Jumlah Siswa</span>
                                  </p>
                              </div>
                      ...
                      <div class="col s12 m6 l4">
                          <div class="card">
                              <div class="card-content purple darken-1 white-text">
                                  ...
                                  <h4 class="card-stats-number"></h4>
                                  <p class="card-stats-compare"><?php echo $data['jumlah_guru']; ?> <span class="green-text text-lighten-5">Jumlah Guru</span>
                                  </p>
                              </div>
                      ...
                      <div class="col s12 m6 l4">
                          <div class="card">
                              <div class="card-content  orange darken-1 white-text">
                                  <i class="mdi-action-home medium"></i>
                                  <h4 class="card-stats-number"></h4>
                                  <p class="card-stats-compare"><?php echo $data['jumlah_kelassiswa']; ?> <span class="green-text text-lighten-5">Jumlah Kelas Siswa</span>
                                  </p>
                              </div>
