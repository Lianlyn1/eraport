 ...
 <?php
  ...
  ?>
   <tr>
     ...
     <td>
       <center><?php echo "$data[nilai_tugas]"; ?></center>
     </td>
     <td>
       <center><?php echo "$data[nilai_tugas2]"; ?></center>
     </td>
     <td>
       <center><?php echo "$data[nilai_tugas3]"; ?></center>
     </td>
     <td>
       <center><?php echo "$data[nilai_uts]"; ?></center>
     </td>
     <td>
       <center><?php echo "$data[nilai_uas]"; ?></center>
     </td>
