...
$kodesaya = $_GET['id'];
$sql = mysqli_query($connect, "SELECT nilai.*, pelajaran.nama_pelajaran, siswa.nama_siswa, siswa.nis, datakelas.jurusan, guru.nama_guru FROM nilai, pelajaran, siswa, datakelas, guru 
...
<table border="1" cellspacing="0" cellpadding="5">
    ...
    <?php
    $no = 1;
    $sql = mysqli_query($connect, "SELECT nilai.*, pelajaran.nama_pelajaran, siswa.nama_siswa, siswa.nis, datakelas.jurusan FROM nilai, pelajaran, siswa, datakelas 
