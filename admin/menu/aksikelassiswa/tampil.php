             ...
             <?php
              ...
              ?>
               <tr>
                 ...
                 <td>
                   <center><a href="?menu=kelassiswa&aksi=editdatakelassiswa&id=<?php echo $data['kode_datakelas']; ?>" class="btn-floating waves-effect waves-light btn-flat deep-purple btn tooltipped" data-position="left" data-delay="50" data-tooltip="Edit"><i class="mdi-content-create"></i></a> &nbsp;
                     <a onClick="swal({
                                            title: 'Anda yakin?',
