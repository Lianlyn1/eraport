<div class="row">
  <div class="col s12 m12 l12">
    <div class="card-panel">
      ...
      <div class="row">
        <?php
        $edit = mysqli_query($connect, "select * from siswa, datakelas where kode_datakelas='$_GET[id]' and datakelas.kode_siswa=siswa.kode_siswa") or die("gagal" . mysqli_error($connect));
            ...
            <div class="row">
              <div class="input-field col s12 m6 l6">
                <select name="kode_kelas" id="kode_kelas" disabled>
                  ...
                  ?>
                    <option value="<?php echo $data2['kode_kelas']; ?>" <?php if ($data2['kode_kelas'] == $data['kode_kelas']) {
                                                                          echo "selected";
                                                                        } ?>><?php echo $data2['nama_kelas']; ?> | <?php echo $data2['tahun_ajar']; ?></option>';
              ...
              <div class="input-field col s12 m6 l6" style="display: none;">
                <select name="jurusan" id="jurusan">
                  ...
                  <option value="Teknik Komputer & Jaringan" <?php if ($data['jurusan'] == "Teknik Komputer & Jaringan") {
                                                                echo "selected";
                                                              } ?>>Teknik Komputer dan Jaringan</option>
                  <option value="Administrasi Perkantoran" <?php if ($data['jurusan'] == "Administrasi Perkantoran") {
                                                              echo "selected";
                                                            } ?>>Admistrasi Perkantoran</option>
                </select>
                <label>Jurusan</label>
              </div>
            </div>
