...
if (isset($_SESSION['user']) and isset($_SESSION['pass'])) {
    $ceksession = mysqli_query($connect, "SELECT nama_user FROM user WHERE username='$_SESSION[user]'");
    $datasession = mysqli_fetch_array($ceksession);
            ...
            <div class="wrapper"> <!-- START WRAPPER -->
                ...
                <section id="content">
                                ...
                                <div class="col s12 m12 l12">
                                    <h5 class="breadcrumbs-title">
                                        ...
                                        if ($url == "home") {
                                            ...
                                            $judul = "Siswa";
                                        } elseif ($url == "pelajaran") {
                                            $judul = "Mata Pelajaran";
                                        } elseif ($url == "kelas") {
                                            $judul = "Kelas";
                                        } elseif ($url == "kelassiswa") {
                                            $judul = "Kelas Siswa";
                                        } elseif ($url == "nilai") {
                                            $judul = "Nilai";
                                        } elseif ($url == "profil") {
                                            ...
                                            $judul = "User";
                                        } elseif ($url == "laporansiswa") {
                                            $judul = "Laporan Siswa";
                                        } elseif ($url == "laporanguru") {
                                            $judul = "Laporan Guru";
                                        } elseif ($url == "laporankelas") {
                                            $judul = "Laporan Kelas";
                                        } elseif ($url == "laporannilai") {
                                            $judul = "Laporan Nilai";
                                        } elseif ($url == "laporanpelajaran") {
                                            $judul = "Laporan Pelajaran";
                                        } else {
                                            $judul = "Home";
                                        }
                                        echo $judul;
                                    ...
                                    <ol class="breadcrumb">
                                        <?php
                                        if (isset($_GET['menu'])) {
                                            if ($url == "home") { ?> <li class="active">Dashboard</li> <?php } elseif ($url == "guru") {
                                                                                                        if ($url2 == "tambahdataguru") { ?> <li><a href="?menu=home">Dashboard</a></li>
                                                    <li><a href="?menu=guru">Guru</a></li>
                                                    <li class="active">Tambah Data</li> <?php } elseif ($url2 == "editdataguru") { ?> <li><a href="?menu=home">Dashboard</a></li>
                                                    <li><a href="?menu=guru">Guru</a></li>
                                                    <li class="active">Edit Data</li> <?php } else { ?> <li><a href="?menu=home">Dashboard</a></li>
                                                    <li class="active">Guru</li> <?php }
                                                                                                    } elseif ($url == "siswa") {
                                                                                                        if ($url2 == "tambahdatasiswa") { ?> <li><a href="?menu=home">Dashboard</a></li>
                                                    <li><a href="?menu=siswa">Siswa</a></li>
                                                    <li class="active">Tambah Data</li> <?php } elseif ($url2 == "editdatasiswa") { ?> <li><a href="?menu=home">Dashboard</a></li>
                                                    <li><a href="?menu=siswa">Siswa</a></li>
                                                    <li class="active">Edit Data</li> <?php } else { ?> <li><a href="?menu=home">Dashboard</a></li>
                                                    <li class="active">Siswa</li> <?php }
                                                                                                    } elseif ($url == "pelajaran") {
                                                                                                        if ($url2 == "tambahdatapelajaran") { ?> <li><a href="?menu=home">Dashboard</a></li>
                                                    <li><a href="?menu=pelajaran">Mata Pelajaran</a></li>
                                                    <li class="active">Tambah Data</li> <?php } elseif ($url2 == "editdatapelajaran") { ?> <li><a href="?menu=home">Dashboard</a></li>
                                                    <li><a href="?menu=pelajaran">Mata Pelajaran</a></li>
                                                    <li class="active">Edit Data</li> <?php } else { ?> <li><a href="?menu=home">Dashboard</a></li>
                                                    <li class="active">Mata Pelajaran</li> <?php }
                                                                                                    } elseif ($url == "kelas") {
                                                                                                        if ($url2 == "tambahdatakelas") { ?> <li><a href="?menu=home">Dashboard</a></li>
                                                    <li><a href="?menu=kelas">Kelas</a></li>
                                                    <li class="active">Tambah Data</li> <?php } elseif ($url2 == "editdatakelas") { ?> <li><a href="?menu=home">Dashboard</a></li>
                                                    <li><a href="?menu=kelas">Kelas</a></li>
                                                    <li class="active">Edit Data</li> <?php } else { ?> <li><a href="?menu=home">Dashboard</a></li>
                                                    <li class="active">Kelas</li> <?php }
                                                                                                    } elseif ($url == "kelassiswa") {
                                                                                                        if ($url2 == "tambahdatakelassiswa") { ?> <li><a href="?menu=home">Dashboard</a></li>
                                                    <li><a href="?menu=kelassiswa">Kelas Siswa</a></li>
                                                    <li class="active">Tambah Data</li> <?php } elseif ($url2 == "editdatakelassiswa") { ?> <li><a href="?menu=home">Dashboard</a></li>
                                                    <li><a href="?menu=kelassiswa">Kelas Siswa</a></li>
                                                    <li class="active">Edit Data</li> <?php } else { ?> <li><a href="?menu=home">Dashboard</a></li>
                                                    <li class="active">Kelas Siswa</li> <?php }
                                                                                                    } elseif ($url == "nilai") {
                                                                                                        if ($url2 == "tambahdatanilai") { ?> <li><a href="?menu=home">Dashboard</a></li>
                                                    <li><a href="?menu=nilai">Nilai</a></li>
                                                    <li class="active">Tambah Data</li> <?php } elseif ($url2 == "editdatanilai") { ?> <li><a href="?menu=home">Dashboard</a></li>
                                                    <li><a href="?menu=nilai">Nilai</a></li>
                                                    <li class="active">Edit Data</li> <?php } else { ?> <li><a href="?menu=home">Dashboard</a></li>
                                                    <li class="active">Nilai</li> <?php }
                                                                                                    } elseif ($url == "user") {
                                                                                                        if ($url2 == "tambahdatauser") { ?> <li><a href="?menu=home">Dashboard</a></li>
                                                    <li><a href="?menu=user">User</a></li>
                                                    <li class="active">Tambah Data</li> <?php } elseif ($url2 == "editdatauser") { ?> <li><a href="?menu=home">Dashboard</a></li>
                                                    <li><a href="?menu=user">User</a></li>
                                                    <li class="active">Edit Data</li> <?php } else { ?> <li><a href="?menu=home">Dashboard</a></li>
                                                    <li class="active">User</li> <?php }
                                                                                                    } elseif ($url == "profil") { ?> <li><a href="?menu=home">Dashboard</a></li>
                                                <li class="active">Profil</li> <?php } elseif ($url == "laporansiswa") { ?> <li><a href="?menu=home">Dashboard</a></li>
                                                <li class="active">Laporan Siswa</li> <?php } elseif ($url == "laporanguru") { ?> <li><a href="?menu=home">Dashboard</a></li>
                                                <li class="active">Laporan Guru</li> <?php } elseif ($url == "laporankelas") { ?> <li><a href="?menu=home">Dashboard</a></li>
                                                <li class="active">Laporan Kelas</li> <?php } elseif ($url == "laporannilai") { ?> <li><a href="?menu=home">Dashboard</a></li>
                                                <li class="active">Laporan Nilai</li> <?php } elseif ($url == "laporanpelajaran") { ?> <li><a href="?menu=home">Dashboard</a></li>
                    ...
                    if (isset($_GET['menu'])) {
                        ...
                        } elseif ($menu == "pelajaran") {
                            include "menu/pelajaran.php";
                        } elseif ($menu == "kelas") {
                            include "menu/kelas.php";
                        } elseif ($menu == "kelassiswa") {
                            include "menu/kelassiswa.php";
                        } elseif ($menu == "nilai") {
                            include "menu/nilai.php";
                        } elseif ($menu == "profil") {
                            include "menu/profil.php";
                        } elseif ($menu == "user") {
                            include "menu/user.php";
                        } elseif ($menu == "laporansiswa") {
                            include "menu/laporansiswa.php";
                        } elseif ($menu == "laporanguru") {
                            include "menu/laporanguru.php";
                        } elseif ($menu == "laporankelas") {
                            include "menu/laporankelas.php";
                        } elseif ($menu == "laporannilai") {
                            include "menu/laporannilai.php";
                        } elseif ($menu == "laporanpelajaran") {
                            include "menu/laporanpelajaran.php";
                        } else {
