...
$kelas = $_GET['id'];
$query = mysqli_query($connect, "SELECT * FROM kelas WHERE kode_kelas='$kelas'");
...
<table border="1" cellspacing="0" cellpadding="5">
    ...
    $kelas = $_GET['id'];
    $no = 1;
    $sql = mysqli_query($connect, "SELECT * FROM siswa, datakelas WHERE datakelas.kode_siswa=siswa.kode_siswa AND datakelas.kode_kelas='$kelas'");
