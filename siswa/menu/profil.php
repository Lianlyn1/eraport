        ...
        <div class="col s12 m12 l12">
          ...
          <div id="profile-card" class="card">
            ...
            <div class="card-content">
              ...
              $query = mysqli_query($connect, "SELECT * FROM siswa WHERE nis='$username'");
              $data = mysqli_fetch_array($query);
              ?>
              <span class="card-title activator grey-text text-darken-4"><?php echo $_SESSION['nama']; ?></span>
              <p><i class="mdi-action-description"></i><?php echo $data['nis'];  ?></p>
            ...
            <div class="card-reveal">
              ...
              <p><i class="mdi-social-cake"></i> <?php echo $data['tmp_lahir']; ?>, <?php echo $data['tgl_lahir'];  ?>
              <p><i class="mdi-communication-contacts"></i> <?php echo $data['agama']; ?></p>
              </p>
            </div>
          </div>
        </div>
