                 ...
                 <?php
                  ...
                  ?>
                   <tr>
                     ...
                     <td>
                       <center><?php echo "$cari2[semester]"; ?></center>
                     </td>
                     <td>
                       <center><?php echo "$cari2[nilai_tugas]"; ?></center>
                     </td>
                     <td>
                       <center><?php echo "$cari2[nilai_tugas2]"; ?></center>
                     </td>
                     <td>
                       <center><?php echo "$cari2[nilai_tugas3]"; ?></center>
                     </td>
                     <td>
                       <center><?php echo "$cari2[nilai_uts]"; ?></center>
                     </td>
                     <td>
                       <center><?php echo "$cari2[nilai_uas]"; ?></center>
                     </td>
                     <td>
